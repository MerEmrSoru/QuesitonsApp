...
namespace QuesitonsApp
{
    public partial class FormUserList : Form
    {
        ...
        private void fillAllUserToolStripButton_Click(object sender, EventArgs e)
        {
            try
            {
                this.tbl_UserTableAdapter.FillAllUser(this.quesitonAppDataSet3.Tbl_User);
            }
        ...
        private void fillStudentToolStripButton_Click(object sender, EventArgs e)
        {
            try
            {
                this.tbl_UserTableAdapter.FillStudent(this.quesitonAppDataSet3.Tbl_User);
            }
            catch (System.Exception ex)
            {
                System.Windows.Forms.MessageBox.Show(ex.Message);
        ...
        private void fillTeacherToolStripButton_Click(object sender, EventArgs e)
        {
            try
            {
                this.tbl_UserTableAdapter.FillTeacher(this.quesitonAppDataSet3.Tbl_User);
            }
            catch (System.Exception ex)
            {
                System.Windows.Forms.MessageBox.Show(ex.Message);
        ...
        private void fillAdminToolStripButton_Click(object sender, EventArgs e)
        {
            try
            {
                this.tbl_UserTableAdapter.FillAdmin(this.quesitonAppDataSet3.Tbl_User);
            }
            catch (System.Exception ex)
            {
                System.Windows.Forms.MessageBox.Show(ex.Message);
